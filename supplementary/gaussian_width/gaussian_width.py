# This code shows the relationship between wavelength and meep frequency for the frequency range used in this study.
...
def get_colors(num_colors):
    ...
    cmap_viridis = plt.colormaps.get_cmap('viridis')
